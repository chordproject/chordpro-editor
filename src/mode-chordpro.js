...
ace.define('ace/mode/chordpro', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/chordpro_highlight_rules'], function(require, exports, module) {
...
ace.define('ace/mode/chordpro_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function(require, exports, module) {
	var oop = require("ace/lib/oop");
	...
	var ChordproHighlightRules = function() {
		...
		this.$rules = {
			"start": [{
				...
				regex: reOpenBrace + "(title|t|subtitle|st|artist|album|key|k)" + reColon + "(.*)" + reCloseBrace,
				caseInsensitive: true
			}, {
